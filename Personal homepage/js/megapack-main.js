...
/* Type Text */
    ...
    if ($("#personal").length) {
        ...
        personal.typeString('软件开发工程师').pauseFor(2000).deleteAll()
            .typeString('阿里云官方认证博主').pauseFor(2000).deleteAll()
            .typeString('后端开发者').pauseFor(2000).deleteAll()
            .typeString('全栈开发者').start();
    }
